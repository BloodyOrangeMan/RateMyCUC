...
export class CommentService {
  ...
  async createForReview(reviewId: number, createCommentDto: CreateCommentDto): Promise<Comment> {
    const comment = this.commentRepository.create({ ...createCommentDto, reviewId });
    return this.commentRepository.save(comment);
  }
}
